...
export function CashAdvanceTable({ advances }: CashAdvanceTableProps) {
  return (
    <>
          ...
          <tbody className="divide-y divide-border">
            {advances.map((advance) => (
              <tr key={advance.cash_advance_id}>
                ...
                <td className="px-4 py-3 text-sm text-foreground">{advance.operation_member_name}</td>
                ...
                <td className="px-4 py-3 text-sm">
                  <div className="flex gap-3">
                    ...
                    <Link
                      href={`/cash-advances/${advance.cash_advance_id}/edit`}
                      className="font-medium text-accent hover:underline"
                    >
                      Edit
                    </Link>
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-foreground">{advance.operation_member_name}</p>
